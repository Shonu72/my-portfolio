...
const apps: App[] = [
	{
		id: 1,
		name: 'Universal Package Viewer',
		description: 'A Flutter package to preview various file types, including images, videos, PDFs, Word, Excel, CSV, and PowerPoint files on Android and iOS.',
		technologies: ['Flutter', 'Dart', 'CI-CD', 'GitHub Actions'],
	...
	},
	{
		id: 2,
		name: 'iQuantsGraph',
		description: 'Mutual fund investment app using BSE APIs with UCC creation, mandate & AOF upload.',
		technologies: ['Flutter', 'Riverpod', 'Dio', 'SQLite', 'MVC-Pattern', 'CI/CD','Push Notification','Razorpay', ],
	...
	},
	{
		id: 3,
		name: 'Rise Pathway',
		description: 'MVP Behavioral wellness app for youth with journaling, mentor chat, and daily self-help challenges.',
		technologies: ['Flutter', 'Rest-API', 'GetX', 'DIO', 'MVC-Pattern', 'Animation', 'Push Notification'],
	...
	{
		id: 4,
		name: 'Fantasy Banking',
		description: 'Fintech MVP with investments, QR/POS payments, PDF export, and biometric login.',
		technologies: ['Flutter', 'Firebase', 'GetX', 'DIO', 'MVC-Pattern', 'WorkManager', 'Stripe', 'POS Integration', 'Biometric Authentication'],
		platforms: ['Android', 'iOS'],
		downloads: 'Under Review',
		rating: 0,
	},
	{
		id: 5,
		name: 'Private Jet Control System',
		description: 'Built backend to control internal jet features. CI/CD deployed on secure infrastructure.',
		technologies: ['Node.js', 'MySQL', 'Sequelize', 'AWS', 'Docker', 'GitHub Actions'],
		platforms: ['Flutter web, Backend'],
	...
	},
	{
		id: 6,
		name: 'Kesef Deals',
		description: 'E-commerce deal discovery app to explore limited-time offers and expired deals.',
		technologies: ['Flutter', 'GraphQL API', 'Push Notification', 'GetX', 'DIO', 'MVC-Pattern',],
		platforms: ['Android', 'iOS'],
		downloads: '100+',
		rating: 4.7,
	},
	{
		id: 7,
		name: 'Fitness League Gym',
		description: 'Gym management app with member tracking, plans, payments & WhatsApp alerts.',
		technologies: ['Flutter', 'Firebase', 'FCM', 'MVC-Pattern', 'WorkManager'],
		platforms: ['Android'],
		downloads: 'Play Store Live',
		rating: 4.8,
	},
	{
		id: 8,
		name: 'Docnet & Docnet Team',
		description: 'Scalable doctor-patient app with video calls, prescriptions, payments, and multilingual support.',
		technologies: ['Flutter', 'Firebase', 'Agora', 'GetX', 'socket.io', 'MVC-Pattern', 'DIO'],
		platforms: ['Android', 'iOS', 'Web'],
		downloads: '200+',
		rating: 4.8,
	},
	{
		id: 9,
		name: 'Chit Chat',
		description: 'Modern chat app with video/audio calls, stories, and group/1-on-1 messaging.',
		technologies: ['Flutter', 'Firebase', 'Agora', 'GetX', 'MVVM-Pattern', 'Clean-Architecture', 'Rive Animation'],
		platforms: ['Android'],
		downloads: 'Private',
		rating: 4.6,
	},
	{
		id: 10,
		name: 'ZenFit (In Progress)',
		description: 'Platform for GYM owner & member for goal tracking, trainer connect, and wellness insights, etc.',
		technologies: ['Flutter', 'Riverpod', 'Clean-Architecture', 'Node.js', 'MySQL', 'FCM', 'AWS',],
		platforms: ['Android', 'iOS'],
