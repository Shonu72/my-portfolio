			...
			<div className="max-w-4xl mx-auto">
				...
				>
					<h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
						Let&apos;s Build Exceptional Mobile Experiences
					</h2>
					<p className="text-gray-400 max-w-2xl mx-auto">
						Have an app idea? I specialize in building high-performance, intuitive mobile applications tailored to your goals.
					</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:sonu.shour77@gmail.com"
						...
						<a
							href="https://drive.google.com/file/d/1RqTa7BZpLKAuu6UpH5zRg0HB8pjrJS1x/view"
							target="_blank"
					...
					<div className="flex justify-center gap-6 pt-4">
						...
						<a
							href="https://linkedin.com/in/sonu7250"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
						>
						...
						<a
							href="https://x.com/KushwahaShonu"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
						>
