...
const processes: Process[] = [
	{
		...
		steps: ['Understand client goals and pain points', 'Sketch user journeys and UX flows', 'Develop interactive prototypes for early feedback'],
	},
	{
		title: 'Development',
		colorClasses: {
		...
		steps: ['Setup Flutter + Firebase/Node backend', 'Implement clean architecture with GetX/MVC', 'Follow CI/CD & agile methodology'],
	},
	{
		title: 'Launch & Growth',
		colorClasses: {
		...
		steps: ['Deploy to App Store & Play Store', 'Track metrics using Firebase Analytics', 'Ship frequent updates and gather feedback'],
	},
];
		...
		<section className="py-16 md:py-20 relative">
			<div className="container mx-auto px-4">
				...
				<p className="text-sm sm:text-base text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
					A practical approach I follow to deliver polished, production-ready mobile apps
				</p>
